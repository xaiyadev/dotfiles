...
in
{
  ...
  config = mkIf cfg.enable {
    age.secrets = {
      lastfm-apikey.rekeyFile = "${self}/secrets/lastfm-apikey.age";
      tailscale-apikey.rekeyFile = "${self}/secrets/tailscale-apikey.age";
    };
                ...
                widgets = [
                  {
                    ...
                    "parameters" = {
                      ...
                      "user" = "xaiyadev";
                      "api_key" = "${(builtins.readFile config.age.secrets.lastfm-apikey.path)}";
                      "format" = "json";
                      "limit" = "5";
                    };
...

                  {
                    ...
                    headers = {
                      Authorization = "Bearer ${(builtins.readFile config.age.secrets.lastfm-apikey.path)}";
                    };
                    cache = "10m";
                    template = ''
                      {{/* User Variables */}}
